...
**Engineering signal:** [GanitaSutra-v0](https://github.com/ganeshgowri-ASA/GanitaSutra-v0) pushed on 9 May 2026, now carrying **16 open issues** (up from 9 on 3 May). The active sprint is the PV toolbox curve-fitting module — specifically, a five-parameter single-diode model (5PDM) fitted via Levenberg-Marquardt (LM) optimisation. When this lands, Surya Yantra gains zero-datasheet IEC 60891 P3/P4 corrections.
