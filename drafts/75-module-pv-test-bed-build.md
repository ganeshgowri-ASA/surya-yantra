...
A 2-wire connection includes Force-cable resistance in the measured voltage — typically 0.1–0.5 Ω at these currents, causing a Voc error of 0.5–2.5 V. Kelvin sensing carries voltage on a separate current-free pair, eliminating this error. The technique is standard in precision IV measurement per IEC 60904-1:2020 and in battery internal resistance measurement; its application to outdoor PV rack testing is less commonly documented.
...
<!-- TODO: Ideation→implementation diagram -->
...
6. Mahan A.H., Yan B., Shu J., Wagner S. (2009). *Measurement of the temperature coefficient of the photocurrent of amorphous Si:H solar cells*. Applied Physics Letters. [Reference for Kelvin-sensing importance in thin-film measurements.]
7. ET SolarPower, *ESL-Solar 500 User Manual*, FW 1.12, ET SolarPower, Shenzhen.
