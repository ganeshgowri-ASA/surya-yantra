...
## Active drafts (as of 2026-05-09)
...
| `antaryami-os-42-issue-sprint-governance.md` | AI governance for physical lab OS | 🌱 Seed | **New seed 2026-05-09** (Fri) |
| `shilpasutra-cad-pv-fixture-design.md` | ShilpaSutra AI-CAD for test rack | 🌱 Seed | **New seed 2026-05-09** (Fri) |

## Companion repo sprint state (9 May 2026)

| Repo | Open issues | Pushed | Signal |
|------|-------------|--------|--------|
| antaryami-os | **42** (+9 today) | 2026-05-09 02:15 IST | 🔴 Highest-velocity repo |
| ShilpaSutra | **37** (+4 today) | 2026-05-09 03:36 IST | 🔴 Active sprint |
| GanitaSutra-v0 | **16** (+1) | 2026-05-08 | 🟠 Active |
| SolarLabX | **18** (stable) | 2026-05-08 | 🟠 Active |
