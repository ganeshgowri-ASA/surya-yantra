...
| [GanitaSutra-v0](https://github.com/ganeshgowri-ASA/GanitaSutra-v0) | PV toolbox active sprint | **14 open issues** (up from 9 on 3 May); pushed 6 May |
| [Antaryami-OS](https://github.com/ganeshgowri-ASA/antaryami-os) | AI scheduling active development | **31 open issues** (up from 4 on 3 May — 7× increase!); pushed 6 May |
| [SolarLabX](https://github.com/ganeshgowri-ASA/SolarLabX) | LIMS / QMS target | 12 open issues; webhook contract definition pending |
