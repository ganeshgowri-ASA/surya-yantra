...
This integration is the technical realisation of the Q2 2026 roadmap item in `posts/surya-yantra-open-source-pv-iv-tracer.md`. GanitaSutra’s sprint velocity (5 new issues in 3 days) suggests this could ship in Q2 2026. The Surya Yantra side is already designed; only the GanitaSutra package publication is on the critical path.
