...
*Roadmap seed — 3 May 2026 · Srishti PV Lab Engineering*
...
This integration is the technical realisation of the Q3 2026 roadmap item in `posts/surya-yantra-open-source-pv-iv-tracer.md`:

> Q3 2026 — GanitaSutra coefficient-extraction integration for parameter-free P3/P4 corrections

GanitaSutra's active sprint suggests this could ship in Q2 2026 rather than Q3. The Surya Yantra side is already designed; only the GanitaSutra package publication is on the critical path.

<!-- TODO: Update roadmap in surya-yantra-open-source-pv-iv-tracer.md once GanitaSutra sprint timeline is confirmed -->
