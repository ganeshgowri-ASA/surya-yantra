...
- **GanitaSutra-v0 connection**: GanitaSutra’s PV toolbox (14 open issues as of 6 May 2026) will add a curve-fitting module that extracts α˳ᵉˡ and Rₛ from two measured curves automatically — making P3 the zero-configuration default correction path.
