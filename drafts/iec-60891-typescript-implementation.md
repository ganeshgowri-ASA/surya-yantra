...
| P2 — Multiplicative | αʳᵉˡ, β, Rₛ, κ | Large irradiance translations, indoor flash |
| P3 — Bilinear | Two reference curves | Unknown module parameters |
| P4 — Extended parametric | αʳᵉˡ, β, Rₛ, κ, Rₛʰ | Very low irradiance, leakage-dominated |
...
- **GanitaSutra-v0 connection**: GanitaSutra's PV toolbox (17 open issues as of 10 May 2026) will add a curve-fitting module that extracts αʳᵉˡ and Rₛ from two measured curves automatically — making P3 the zero-configuration default correction path.
...
```
I₂ = I₁ · (1 + αʳᵉˡ · ΔT) · (G₂/G₁) + (V₁ / R_sh) · (G₂/G₁ − 1)
V₂ = V₁ + β · ΔT − Rₛ · (I₂ − I₁) − κ · I₂ · ΔT
```
